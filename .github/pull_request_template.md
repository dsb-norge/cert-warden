...
This is a PUBLIC repo: never reference private DSB repositories in files or commit messages.
-->
...
<!-- The PR gets a `preview/pr-<N>` tag automatically (see the sticky comment) — use it to
test from a calling repo when relevant. -->
